        ...
        public void run()
        {
            ...
            try
            {
                ...
                if(value.equalsIgnoreCase("Heartbeat")){
                    ...
                    JsonObject jsonRootObject = Json.createObjectBuilder().add("PacketType", "Heartbeat Response")
                            .build();
                    ...
                    JsonObject jsonRootObject = Json.createObjectBuilder().add("PacketType", "GetRegisteredVehicles Response")
                            .build();
                    ...
                    socketWriter.println("I don't understand, sorry : (");
                }
                 }
                //socket.close();
            }
